...
```{r MIG alternate, echo=FALSE, warning=FALSE, message= FALSE}

ggplot(data = MIGexplantDat, aes(x = Timepoint, y = Calc..Concentration))+
...
```{r RANTES alternate, echo=FALSE, warning=FALSE, message= FALSE}

ggplot(data = RANTESexplantDat, aes(x = Timepoint, y = Calc..Concentration))+
...
```{r IL1RA alternate, echo=FALSE, warning=FALSE, message= FALSE}

ggplot(data = IL1RAexplantDat, aes(x = Timepoint, y = Calc..Concentration))+
