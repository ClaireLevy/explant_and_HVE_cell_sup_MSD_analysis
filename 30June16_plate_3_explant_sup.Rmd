...
# standardCurve<- function (Calc.Top, Calc.Bottom, Calc.HillSlope, Calc.Midpoint, Concentration){
# 
# Calc.Top + (Calc.Bottom - Calc.Top/(1+(Concentration/Calc.Midpoint)^Calc.HillSlope))
# }
# 
# 
# MIGcurveData <- standards%>%
#   filter(Assay == "MIG") %>%
#   mutate(UpperLimit = Algorithm.Parameter..Calc..Top-( Detection.Limits..Top.of.Range.Parameter * Std..Deviation ))%>%
#   mutate(LowerLimit = min(Concentration)+(2.5 * Std..Deviation ))
# 
# 
# 
# MIGcalcCurve <- standardCurve(MIGcurveData$Algorithm.Parameter..Calc..Top,MIGcurveData$Algorithm.Parameter..Calc..Bottom, MIGcurveData$Algorithm.Parameter..Calc..HillSlope, MIGcurveData$Algorithm.Parameter..Calc..MidPoint, MIGcurveData$Concentration)
# 
# 
# ggplot(MIGcurveData, aes(x = Concentration, y = Signal))+
#   geom_point()+
#   scale_y_log10()+
#   scale_x_log10()+
#   geom_line(aes(y = MIGcalcCurve))+
#   geom_hline(yintercept = MIGcurveData$UpperLimit)
...
```{r everything, echo=FALSE, warning=FALSE, message= FALSE}
