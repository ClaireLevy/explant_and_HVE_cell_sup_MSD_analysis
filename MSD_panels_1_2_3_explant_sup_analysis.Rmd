...
mergeMock<- mergeMock %>%
  mutate(minusMockEstConc = avgEstConcVirus-avgEstConcMock)
...
mergeMock <- mergeMock %>%
  mutate(minusMockEstConc = ifelse(minusMockEstConc <= 0, 0.01, minusMockEstConc))
...
* Samples for which there was only data for a Mock sample and neither of the virus conditions (Donor 324, IL-1RA, MIG, RANTES)
...
ggplot(mergeMock, aes(x = Timepoint, y = minusMockEstConc))+
